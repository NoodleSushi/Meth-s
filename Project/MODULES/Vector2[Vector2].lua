----------------------------------------------------------------------------------------
--    Title: LOVE2D-Vector2
--    Author: Brent Duanne AKA XanTheDragon
--    Date: May 19, 2016
--    Code version: UNKNOWN
--    Availability: https://github.com/XanTheDragon/LOVE2D-Vector2
----------------------------------------------------------------------------------------
local vec2 = {}
...
function vec2.new(x, y)
	...
	v.mt ={} --Our metatable
	setmetatable(v, v.mt)
	local tovec2 = function(B)
		local D = B
		if type(D) == "number" then D = vec2.new(B,B) end
		return D
	end
	v.Add = function (a, b)
		local a = tovec2(a)
